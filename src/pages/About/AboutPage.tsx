...
export default function AboutPage() {
  ...
  return (
    ...
    <PageLayout title={"About Us"} imgUrl={"/banners/aboutusbanner.png"}>
      ...
      <div id="about-content-anchor" className='px-4 sm:px-0 flex justify-center items-center py-10 md:py-16'>
        ...
        */}
        ...
        >
          ...
          {/* Vision Section */}
          <div className="mt-12">
            <h2 className="text-3xl font-semibold font-figtree text-gray-800 mb-4">
              Our Vision
            </h2>
            <p className="text-gray-700 text-base md:text-lg">
              To create an open, collaborative, and innovative tech ecosystem at NIT Srinagar and beyond, where students learn, build, and contribute through open-source technology to make a real-world impact.
            </p>
          </div>
          ...
          <div className="mt-12">
            ...
            <p className="text-gray-700 mb-6 text-base md:text-lg">
              FOSS NIT Srinagar strives to:
            </p>
            <ul className="list-disc list-inside space-y-3 text-gray-700">
              <li>
                Foster a strong open-source culture on campus and across Kashmir.
              </li>
              <li>
                Encourage exploration, learning, and contribution to open-source projects.
              </li>
              <li>
                Organize workshops, hackathons, and events for hands-on skill development and collaboration.
              </li>
              <li>
                Connect developers, designers, and innovators to build impactful projects.
              </li>
              <li>
                Cultivate a knowledge-sharing, inclusive community where ideas thrive.
              </li>
              <li>
                Empower students to master modern technologies and contribute globally.
              </li>
            </ul>
          </div>
        </div>
